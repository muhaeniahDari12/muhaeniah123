                ...
                <div class="card">
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="largeInput">Jumlah (kg)</label>
                            ...
                            <div class="form-group">        
                                ...
                                <input type="text" name="pajak" class="form-control form-control" id="defaultInput" value="10" readonly> 
                            </div>

...
<head>
    ...
    <link rel="icon" href="../assets/img/2.png" type="image/x-icon" />
    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <button class="navbar-toggler sidenav-toggler ml-auto" type=" " data-toggle="collapse" data-target="collapse" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="../assets/img/avatar.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
